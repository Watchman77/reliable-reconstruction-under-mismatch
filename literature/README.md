...
Eighty AI full-text assessments are complete: 79 include recommendations and 1 exclude; 10 remain. Ten assessments were added in checkpoint 08. See [the report](screening/full_text_08_report.md), [criterion-level register](screening/full_text_08.json), [change audit](screening/full_text_08_changes.json) and [deferred work](screening/deferred_review_tasks.md). Summary E15 counts completed AI decisions. Screening Log J records those decisions; Matrix AA remains pending final formal eligibility. Only explicitly listed feature fields are verified. Nine PDFs and one full-article XML source were retrieved for this checkpoint; source versions and hashes are recorded. PDF acquisition flags exclude the XML-only record. Paper content is not redistributed.
